...
builder.Services.AddScoped<IRepositoryApi, RepositoryApi>();
builder.Services.AddHttpClient<IRepositoryApi,RepositoryApi>(
...
builder.Services.AddSwaggerGen(
    c => { 
        c.SwaggerDoc("v1", new OpenApiInfo { Title = "Web.API.Consummer", Version = "v1" 
    });
});
...
/*
    ...
    https://economia.awesomeapi.com.br/last/{code}
